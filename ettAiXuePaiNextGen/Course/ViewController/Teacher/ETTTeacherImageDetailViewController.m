//
//  ETTImageDetialViewController.m
//  ettAiXuePaiNextGen
/**
 图片详情
 
 */
//  Created by qitong on 16/10/6.
...
@interface ETTTeacherImageDetailViewController ()<UIGestureRecognizerDelegate>
{
    UIPinchGestureRecognizer *_pinchGes;//缩放手势
    UIPanGestureRecognizer   *_panGes;//旋转手势
    CGPoint                  _startPoint;
...
@implementation ETTTeacherImageDetailViewController
