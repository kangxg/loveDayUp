...
@implementation ETTCoursewareMediaTypeCell
...
- (void)setCoursewareMediaTypeModel:(CoursewareMediaTypeModel *)coursewareMediaTypeModel {
    ...
    switch (_coursewareMediaTypeModel.coursewareType) {
        case 3://图片类型
    ...
    if (_coursewareMediaTypeModel.visible == 1) {//课件的可见性
