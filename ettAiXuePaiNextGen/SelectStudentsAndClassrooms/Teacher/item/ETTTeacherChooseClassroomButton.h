//
//  ETTTeacherChooseClassroomButton.h
//  ettAiXuePaiNextGen
//
//
//                          _oo8oo_
...
#import "ETTKit.h"
#import "ETTTeacherChooseClassConst.h"
#import "ETTTeacherChooseClassroomModel.h"
#import "ETTTeacherChooseClassroomViewVm.h"

typedef NS_ENUM(NSInteger,ETTTeacherChooseClassroomButtonType)
{
    ETTTeacherChooseClassroomButtonTypeSelected = 0,
    
    ETTTeacherChooseClassroomButtonTypeUnSelected
};

@interface ETTTeacherChooseClassroomButton : ETTView
@property (nonatomic,copy) ETTTeacherChooseClassroomModel           *classroomModel;

/**
 *  @author LiuChuanan, 17-05-08 15:39:57
 *  
