...
+ (void)noteErrorWithException:(NSException *)exception defaultToDo:(NSString *)defaultToDo {
    ...
    NSException * ex = [NSException exceptionWithName:errorName reason:errorReason userInfo:errorInfoDic];
    dispatch_async(dispatch_get_main_queue(), ^{
        [[NSNotificationCenter defaultCenter] postNotificationName:AvoidCrashNotification object:ex userInfo:nil];
    });
