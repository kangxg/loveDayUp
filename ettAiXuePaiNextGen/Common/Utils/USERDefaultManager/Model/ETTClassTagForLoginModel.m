...
#import "ETTClassTagForLoginModel.h"

@implementation ETTClassTagForLoginModel

@synthesize classTag        =   _classTag;
...
{
    if (self = [super init]) {
        self.classTag   =   [aDecoder decodeObjectForKey:@"classTag"];
...
-(void)encodeWithCoder:(NSCoder *)aCoder
{
    ...
    [aCoder encodeObject:self.classTag forKey:@"classTag"];
