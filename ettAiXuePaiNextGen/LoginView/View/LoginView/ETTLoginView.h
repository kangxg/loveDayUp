...
@protocol ETTLoginViewDelegate <NSObject>

-(void)gotoTransition:(NSString *)type;

@end

@interface ETTLoginView : ETTView<ETTLoginButtonDelegate,ETTLoginInputViewDelegate>

@property (nonatomic,weak) id<ETTLoginViewDelegate> MDelegate;
